package jooyung.com.balance_api.util.validator

import jooyung.com.balance_api.BalanceConstants
import jooyung.com.balance_api.common.repository.CommonRepository
import jooyung.com.balance_api.enum.Gender
import jooyung.com.balance_api.enum.Theme
import jooyung.com.balance_api.exception.ApiException
import jooyung.com.balance_api.exception.ResultCode
...
class Validator(
    ...
    fun currency(currency: String) {
        ...
        val exists = commonRepository.existsByGroup_GroupCdAndCode(BalanceConstants.GROUP_CURRENCY, currency)
    ...
    fun language(language: String) {
        ...
        val exists = commonRepository.existsByGroup_GroupCdAndCode(BalanceConstants.GROUP_LANGUAGE, language)
    ...
    fun deviceType(deviceType: String) {
        ...
        val exists = commonRepository.existsByGroup_GroupCdAndCode(BalanceConstants.GROUP_DEVICE, deviceType)
    ...
    fun os(os: String) {
        ...
        val exists = commonRepository.existsByGroup_GroupCdAndCode(BalanceConstants.GROUP_OS, os)
    ...
    fun platform(platform: String) {
        ...
        val exists = commonRepository.existsByGroup_GroupCdAndCode(BalanceConstants.GROUP_PLATFORM, platform)
